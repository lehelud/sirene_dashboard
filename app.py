...
def page_vue_ensemble(data, sects):
    ...
    c4.metric("Dont employeurs",fmt(nb_emp),f"{nb_emp/total*100:.1f}% des actives")
    ...
    st.caption("Pour chaque secteur : quelle part a des salaries ? Code NN = non-employeur OU entreprise recente (<3 ans).")
